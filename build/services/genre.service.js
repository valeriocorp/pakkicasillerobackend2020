...
class GenresService extends resolvers_operations_services_1.default {
    ...
    insert() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield this.add(this.collection, genreObject, 'genero');
            return {
                status: result.status,
                message: result.message,
                genre: result.item
    ...
    block() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield this.update(this.collection, { id }, { active: false }, 'genero');
            return {
                status: result.status,
    ...
    checkInDatabase(value) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield db_operations_1.findOneElement(this.getdb(), this.collection, { name: value });
        });
    }
}
